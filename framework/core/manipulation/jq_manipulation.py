...
from framework.core.manipulation.base import BaseManipulation, Entity, EntitiesDiff
from framework.core.utils import get_unique_entities
from framework.models.port import Blueprint
