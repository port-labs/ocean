...
class ServicenowClient:
    ...
    async def get_paginated_resource(
        ...
        enhanced_query = f"{user_query}^{default_ordering}" if user_query else default_ordering
        ...
        logger.info(f"Fetching Servicenow data for resource: {resource_kind} with request params: {params}")
