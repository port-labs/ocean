...
class TestOktaUserExporter:
    ...
    async def test_get_paginated_resources(
        ...
        mock_client.send_api_request = AsyncMock(return_value=mock_groups)

        options = ListUserOptions(include_groups=True, fields="id,profile.login")
    ...
    async def test_get_paginated_resources_with_error(
        ...
        mock_client.send_api_request = AsyncMock(side_effect=raise_error)
