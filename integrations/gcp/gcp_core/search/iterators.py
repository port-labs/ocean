    ...
    **kwargs: Any,
    ...
    try:
        async for projects in search_all_projects():
            ...
            if not tasks:
                logger.warning(
                    f"Searched all projects and found no accessible resources for {kwargs['asset_type']}. This may be due to unset permissions or no currently existing projects."
                )
                return
