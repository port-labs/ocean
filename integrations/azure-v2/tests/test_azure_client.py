...
async def test_run_query_single_page() -> None:
    ...
    client._resource_g_client = mock_resource_client
...
async def test_run_query_throttling_handled() -> None:
    ...
    client = SDKClient()
    client._resource_g_client = MagicMock()
    ...
    client._resource_g_client.resources = AsyncMock(
        side_effect=[
            throttled_exception,
    ...
    with patch("azure_integration.errors.asyncio.sleep") as mock_sleep:
        ...
        assert client._resource_g_client.resources.call_count == 2
...
async def test_run_query_subscription_limit_reached() -> None:
    ...
    client._resource_g_client.resources.side_effect = [throttled_exception]
