...
class TestListResponseHandling:
    ...
    async def test_auto_detect_list_response(self) -> None:
        ...
        with patch("main.init_client", return_value=mock_client), \
            ...
            direct_list_response = [{"id": 1, "name": "Alice"}, {"id": 2, "name": "Bob"}]
            ...
            mock_ocean.app.integration.entity_processor._search = AsyncMock(return_value=direct_list_response)
    ...
    async def test_explicit_data_path_used_when_provided(self) -> None:
        ...
        with patch("main.init_client", return_value=mock_client), \
            ...
            mock_ocean.app.integration.entity_processor._search = AsyncMock(return_value=extracted_users)
