...
class TestTokenExpiration:
    ...
    async def test_is_expired_no_auth_yet(
        ...
        assert custom_auth_with_interval._expiration_tracker.is_expired() is True
    ...
    async def test_is_expired_no_interval_configured(
        ...
        assert custom_auth_without_interval._expiration_tracker.is_expired() is False
    ...
    async def test_is_expired_not_expired(
        ...
        assert custom_auth_with_interval._expiration_tracker.is_expired() is False
