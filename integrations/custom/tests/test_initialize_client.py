...
class TestEarlyValidation:
    ...
    def test_create_client_validates_template_syntax_before_auth(
        self, mock_ocean_config: None
    ) -> None:
        """Test that template syntax is validated before authentication"""
        from custom.clients.initialize_client import init_client

        client = init_client()
        assert client is not None

    def test_create_client_fails_on_invalid_template_syntax(
    ...
    def test_create_client_fails_on_missing_custom_auth_request(
        self, mock_ocean_config: None, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_create_client_fails_on_missing_custom_auth_request_template(
        self, mock_ocean_config: None, monkeypatch: pytest.MonkeyPatch
    ) -> None:
    ...
    def test_create_client_validates_empty_custom_auth_request_template(
        self, mock_ocean_config: None, monkeypatch: pytest.MonkeyPatch
    ) -> None:
