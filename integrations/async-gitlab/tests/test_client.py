...
MOCK_GITLAB_URL = "https://your_organization_url.com"
...
@pytest.fixture
def mock_gitlab_client() -> GitLabClient:
    return GitLabClient(MOCK_GITLAB_URL, MOCK_ACCESS_TOKEN)

@pytest.mark.asyncio
async def test_get_single_project() -> None:
    client = GitLabClient(MOCK_GITLAB_URL, MOCK_ACCESS_TOKEN)
