...
def mock_azure_client() -> AzureDevopsClient:
    return AzureDevopsClient(MOCK_ORG_URL, MOCK_AUTHENTICATOR, MOCK_AUTH_USERNAME)
...
async def test_get_single_project() -> None:
    client = AzureDevopsClient(MOCK_ORG_URL, MOCK_AUTHENTICATOR, MOCK_AUTH_USERNAME)
...
def test_format_service_url(
    ...
    client = AzureDevopsClient(base_url, MOCK_AUTHENTICATOR, MOCK_AUTH_USERNAME)
