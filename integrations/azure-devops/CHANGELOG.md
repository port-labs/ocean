...
- Added Azure DevOps-specific 429 retry handling that coordinates a shared 360-second cooldown across concurrent requests and retries rate-limited requests up to 10 times before failing.
