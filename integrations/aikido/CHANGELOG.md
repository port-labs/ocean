...
- Fixed pagination stopping early on empty pages when the Aikido API reported more results via X-Has-Next-Page, which could cause entities to be deleted during resync
...
- Converted spec file to JSON (#31805521)
