...
STARTING_STATUS_LABEL = "Sending prompt to agent"
SESSION_RUNNING_STATUS_LABEL = "Agent session running"
PROMPT_SENT_STATUS_LABEL = "Prompt sent"
SESSION_NOT_CONTINUABLE_STATUS_LABEL = "Session cannot accept a prompt"
SESSION_START_FAILED_STATUS_LABEL = "Session start failed"
