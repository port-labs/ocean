...
def _pr(e: Json) -> str:       return e["pull_request"]["number"]
def _issue(e: Json) -> str:    return e["issue"]["number"]
def _push(e: Json) -> str:     return e["after"]
def _rel(e: Json) -> str:      return e["release"]["id"]
def _status(e: Json) -> str:   return e["sha"]
def _wf_run(e: Json) -> str:   return e["workflow_run"]["id"]
