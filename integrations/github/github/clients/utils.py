...
if TYPE_CHECKING:
    from integration import GithubPortAppConfig, GithubRepositoryConfig
...
def get_repository_options(organization: str, organization_type: str, search_params: Optional[RepoSearchParams] = None, included_relationships: Optional[list[str]] = None) -> ListRepositoryOptions:
