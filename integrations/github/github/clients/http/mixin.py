...
class MakeRequestProtocol(Protocol):
    """Protocol defining the methods required by GithubRestMixin."""
    ...
    def _get_next_link(self, link_header: str) -> Optional[str]:
        """Extract the URL from the 'next' link in a GitHub Link header."""
        ...


class GithubRestMixin:
    """Shared REST API functionality for both org and non-org clients."""
