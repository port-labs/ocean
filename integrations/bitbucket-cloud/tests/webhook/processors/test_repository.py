...
@pytest.fixture
def repository_webhook_processor(mock_ocean_context, webhook_client_mock, event: WebhookEvent):
...
class TestRepositoryWebhookProcessor:
    ...
    @pytest.mark.asyncio
    async def test_should_process_event(self, repository_webhook_processor, event_key, expected, mock_event_context):
    ...
    @pytest.mark.asyncio
    async def test_get_matching_kinds(self, repository_webhook_processor, mock_event_context):
    ...
    @pytest.mark.asyncio
    async def test_handle_event(self, repository_webhook_processor, webhook_client_mock, mock_event_context):
    ...
    async def test_validate_payload(
        self, repository_webhook_processor, payload, expected, mock_event_context, mock_ocean_context
    ):
