...
class TestBitbucketWebhookClient:
    ...
    def test_init_with_secret(self, webhook_client_with_secret):
        """Test initialization with a secret."""
        assert webhook_client_with_secret.secret == "test-secret"

    def test_init_without_secret(self, webhook_client_no_secret):
        """Test initialization without a secret."""
        assert webhook_client_no_secret.secret is None

    def test_workspace_webhook_url(self, webhook_client_with_secret):
    ...
    async def test_authenticate_incoming_webhook_with_valid_signature(
        self, webhook_client_with_secret
    ):
        """Test webhook authentication with a valid signature."""
        payload = {"test": "data"}
        valid_signature = compute_signature(webhook_client_with_secret.secret, payload)
    ...
    @pytest.mark.asyncio
    async def test_webhook_exist_not_found(self, webhook_client_with_secret):
        """Test that _webhook_exist returns False when no matching webhook is found."""

        async def fake_paginated_response(api_url):
    ...
    @pytest.mark.asyncio
    async def test_webhook_exist_found(self, webhook_client_with_secret):
    ...
    @pytest.mark.asyncio
    async def test_create_webhook_when_not_exist(self, webhook_client_with_secret):
    ...
    @pytest.mark.asyncio
    async def test_create_webhook_when_already_exists(self, webhook_client_with_secret):
