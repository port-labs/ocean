...
def test_strips_rest_prefix() -> None:
...
def test_single_value_params_are_strings() -> None:
...
def test_repeated_params_are_lists() -> None:
    _, params = parse_next_page_params(
...
def test_duplicate_key_does_not_drop_values() -> None:
    _, params = parse_next_page_params(
