...
- Added support for filter in 'cloud' and 'kubesystem' kind (#56)
- Added separate resource config for 'allocation' v1 and v2 (#56)

### Improvements

- Added separate resource config for 'cloudCost' v1 and v2 (#56)
- Separated 'kubesystem' resource config from 'cloud' (#56)
