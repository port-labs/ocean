...
from github_cloud.entity_processors.entity_processor import FileEntityProcessor, SearchEntityProcessor
...
class GitHubCloudPortAppConfig(PortAppConfig):
    """Port app configuration for GitHub Cloud integration."""
    resources: list[
...
class GitHubCloudHandlerMixin(HandlerMixin):
    """Mixin for GitHub Cloud entity processing."""
    EntityProcessorClass = GitManipulationHandler


class GitHubCloudLiveEventsProcessorManager(LiveEventsProcessorManager, GitHubCloudHandlerMixin):
    """Manager for GitHub Cloud webhook events."""
    pass


class GitHubCloudIntegration(BaseIntegration):
    """Main GitHub Cloud integration class."""

    EntityProcessorClass = GitManipulationHandler

    class AppConfigHandlerClass(APIPortAppConfig):
        CONFIG_CLASS = GitHubCloudPortAppConfig

    def __init__(self, context: PortOceanContext):
        super().__init__(context)

        # Replace default webhook manager with GitHub Cloud-specific one
        self.context.app.webhook_manager = GitHubCloudLiveEventsProcessorManager(
