...
@pytest.fixture
async def processor():
    with patch('github_cloud.webhook_processors.repository_webhook_processor.init_client') as mock_init_client:
...
async def test_process_webhook_event(processor, valid_repo_event):
    ...
    processor.client.fetch_resource.return_value = {'name': 'test-repo', 'full_name': 'org/test-repo'}
