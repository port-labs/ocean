...
class TestCheckmarxSastExporter:
    ...
    def test_build_params_minimal(self, exporter: CheckmarxSastExporter) -> None:
        ...
        options: ListSastOptions = {"scan_id": "scan-123", "project_id": "project-1", "branch": ""}
    ...
    async def test_get_paginated_resources_single_batch(
        ...
        options: ListSastOptions = {"scan_id": scan_id, "project_id": project_id, "branch": ""}
        mock_results = [
    ...
    async def test_get_paginated_resources_correct_endpoint_and_params(
        ...
        scan_id = "scan-789"
        options: ListSastOptions = {"scan_id": scan_id, "project_id": "project-1", "branch": ""}
