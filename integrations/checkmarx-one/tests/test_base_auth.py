...
class TestBaseCheckmarxAuthenticator:
    ...
    def test_init(self, authenticator: MockAuthenticator, mock_http_client: MagicMock) -> None:
    ...
    def test_is_token_expired_valid_token(self, authenticator: MockAuthenticator) -> None:
    ...
    def test_is_token_expired_expired_token(self, authenticator: MockAuthenticator) -> None:
        """Test is_token_expired when token is expired."""
        # Set token to expire 2 minutes ago
        authenticator._token_expires_at = time.time() - 120
        assert authenticator.is_token_expired is True

    def test_is_token_expired_near_expiry(self, authenticator: MockAuthenticator) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_access_token_success(self, authenticator: MockAuthenticator, token_response: Dict[str, Any]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_access_token_without_refresh_token(self, authenticator: MockAuthenticator) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_access_token_with_default_expiry(self, authenticator: MockAuthenticator) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_access_token_authentication_error(self, authenticator: MockAuthenticator) -> None:
        """Test token refresh when authentication fails."""
        with patch.object(authenticator, '_authenticate', side_effect=Exception("Auth failed")):
            with pytest.raises(CheckmarxAuthenticationError, match="Token refresh failed: Auth failed"):
                await authenticator._refresh_access_token()

    @pytest.mark.asyncio
    async def test_get_access_token_no_token(self, authenticator: MockAuthenticator, token_response: Dict[str, Any]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_access_token_expired_token(self, authenticator: MockAuthenticator, token_response: Dict[str, Any]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_access_token_valid_token(self, authenticator: MockAuthenticator) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_auth_headers_success(self, authenticator: MockAuthenticator, token_response: Dict[str, Any]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_auth_headers_no_token(self, authenticator: MockAuthenticator) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_force_refresh(self, authenticator: MockAuthenticator, token_response: Dict[str, Any]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_refresh_token_authentication_error(self, authenticator: MockAuthenticator) -> None:
