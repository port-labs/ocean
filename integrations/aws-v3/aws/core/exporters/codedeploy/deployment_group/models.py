...
class DeploymentGroupProperties(BaseModel):
    alarmConfiguration: Optional[Dict[str, Any]] = Field(default=None, alias="AlarmConfiguration")
    ...
    autoScalingGroups: List[Dict[str, Any]] = Field(default_factory=list, alias="AutoScalingGroups")
    ...
    ec2TagFilters: List[Dict[str, Any]] = Field(default_factory=list, alias="Ec2TagFilters")
    ...
    lastAttemptedDeployment: Optional[Dict[str, Any]] = Field(default=None, alias="LastAttemptedDeployment")
    lastSuccessfulDeployment: Optional[Dict[str, Any]] = Field(default=None, alias="LastSuccessfulDeployment")
    loadBalancerInfo: Optional[Dict[str, Any]] = Field(default_factory=dict, alias="LoadBalancerInfo")
    onPremisesInstanceTagFilters: List[Dict[str, Any]] = Field(default_factory=list, alias="OnPremisesInstanceTagFilters")
    onPremisesTagSet: Dict[str, Any] = Field(default=None, alias="OnPremisesTagSet")
    outdatedInstancesStrategy: Optional[str] = Field(default=None, alias="OutdatedInstancesStrategy")
    serviceRoleArn: Optional[str] = Field(default=None, alias="ServiceRoleArn")
    Tags: List[Dict[str, str]] = Field(default_factory=list)
    targetRevision: Optional[dict[str, Any]] = Field(default=None, alias="TargetRevision")
    terminationHookEnabled: Optional[bool] = Field(default=None, alias="TerminationHookEnabled")
    triggerConfigurations: List[Dict[str, Any]] = Field(default_factory=list, alias="TriggerConfigurations")
