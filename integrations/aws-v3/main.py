...
from aws.core.exporters.codepipeline import ActionExecutionExporter
from aws.core.exporters.codepipeline.action_execution.models import PaginatedActionExecutionRequest
...
async def resync_codepipeline_action_execution(kind: str) -> ASYNC_GENERATOR_RESYNC_TYPE:
    service = ResyncAWSService(
        kind, ActionExecutionExporter, PaginatedActionExecutionRequest, regional=True
    )
    async for batch in service:
        yield batch
