...
from aws.core.exporters.codepipeline import CodePipelinePipelineExecutionExporter
from aws.core.exporters.codepipeline.pipeline_execution.models import PaginatedPipelineExecutionRequest
...
async def resync_codepipeline_pipeline_execution(kind: str) -> ASYNC_GENERATOR_RESYNC_TYPE:
    service = ResyncAWSService(
        kind, CodePipelinePipelineExecutionExporter, PaginatedPipelineExecutionRequest, regional=True
    )
    async for batch in service:
        yield batch
