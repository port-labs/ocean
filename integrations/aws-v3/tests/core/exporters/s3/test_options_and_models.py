...
class TestExporterOptions:
    ...
    def test_initialization_with_required_fields(self) -> None:
        ...
        options = ExporterOptions(region="us-west-2")
    ...
    def test_initialization_with_all_fields(self) -> None:
        ...
        options = ExporterOptions(region="eu-central-1", include=include_list)
    ...
    def test_include_list_validation(self) -> None:
        ...
        options = ExporterOptions(
            region="ap-southeast-1", include=["Action1", "Action2", "Action3"]
        )
...
class TestSingleS3BucketExporterOptions:
    ...
    def test_inheritance(self) -> None:
        ...
        options = SingleS3BucketExporterOptions(
            region="us-west-2", bucket_name="test-bucket"
        )

        assert isinstance(options, ExporterOptions)

    def test_initialization_with_required_fields(self) -> None:
        """Test initialization with required fields."""
        options = SingleS3BucketExporterOptions(
            region="us-west-2", bucket_name="my-test-bucket"
        )
    ...
    def test_missing_bucket_name(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            SingleS3BucketExporterOptions(region="us-west-2")  # type: ignore
    ...
    def test_missing_region(self) -> None:
        """Test that missing region raises ValidationError."""
        with pytest.raises(ValidationError) as exc_info:
            SingleS3BucketExporterOptions(bucket_name="test-bucket")  # type: ignore
    ...
    def test_bucket_name_validation(self) -> None:
        ...
        for bucket_name in valid_bucket_names:
            options = SingleS3BucketExporterOptions(
                region="us-west-2", bucket_name=bucket_name
            )
...
class TestPaginatedS3BucketExporterOptions:
    ...
    def test_inheritance(self) -> None:
        ...
        options = PaginatedS3BucketExporterOptions(region="us-west-2")

        assert isinstance(options, ExporterOptions)

    def test_initialization_with_required_fields(self) -> None:
        """Test initialization with only required fields."""
        options = PaginatedS3BucketExporterOptions(region="us-east-1")
    ...
    def test_no_additional_fields(self) -> None:
        ...
        options = PaginatedS3BucketExporterOptions(region="eu-north-1")
...
class TestS3BucketProperties:
    ...
    def test_initialization_empty(self) -> None:
        ...
        assert properties.BucketName is None
...
class TestS3Bucket:
    ...
    def test_properties_default_factory(self) -> None:
        ...
        # But both should be S3BucketProperties instances
    ...
    def test_bucket_serialization_roundtrip(self) -> None:
        ...
        recreated_bucket = S3Bucket(**bucket_dict)
