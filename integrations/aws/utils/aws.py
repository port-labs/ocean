...
from aws.auth_provider import (
    OrganizationCredentialsProvider,
)
...
provider = OrganizationCredentialsProvider()
_session_manager: SessionManager = SessionManager(provider)
