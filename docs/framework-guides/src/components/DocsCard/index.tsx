    ...
    const content = (
        <>
            ...
            <div className="Card-container">
                <div style={{display: "flex", alignItems: "center", marginBottom: "1.2em"}}>
                    {(props.icon || hoverIcon || props.iconElement) && (
                        <div className="Card-icon-row">
                            ...
                            {props.iconElement &&
                                <div className="Card-icon Card-icon-default">{props.iconElement}</div>}
                        </div>
                    )}
