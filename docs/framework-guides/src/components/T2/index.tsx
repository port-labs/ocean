...
class Termynal {
    ...
    async start() {
        ...
        this.generateFinish(topElement)
        this.container.appendChild(topElement)
        ...
        this.generateRestart(topElement)
        this.lineDelay = this.originalLineDelay
        this.typeDelay = this.originalTypeDelay
        this.startDelay = this.originalStartDelay
    }

    generateRestart(topEl) {
        topEl.onclick = (e) => {
            e.preventDefault()
            this.container.innerHTML = ''
            this.init()
...
function setupTermynal() {
    console.log(document.querySelectorAll(".termy"));
    document.querySelectorAll(
        ".use-termynal").forEach(node => {
...
window.addEventListener('load', setupTermynal);
