...
class ActionExecutionError(Exception):
    ...
    repeating it. Leaving it unset does not leave the run unlabeled: the
    execution manager falls back to a generic failure label, so set one here to
    say something more useful than "Execution failed".
    """
