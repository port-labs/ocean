...
async def db_manager(
    ...
    with (
        patch(
            "port_ocean.database.managers.manager.create_async_engine",
            return_value=mock_engine,
        ),
        patch(
            "port_ocean.database.managers.manager.async_sessionmaker",
...
@pytest.mark.asyncio
async def test_database_settings_validation() -> None:
    """Test that DatabaseSettings validates required fields."""
