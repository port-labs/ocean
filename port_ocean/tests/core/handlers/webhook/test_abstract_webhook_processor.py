...
@pytest.fixture
def processor(webhook_event: WebhookEvent) -> MockWebhookHandler:
    return MockWebhookHandler(webhook_event)


@pytest.mark.asyncio
async def test_successful_processing(
    processor: MockWebhookHandler, processor_manager: WebhookProcessorManager
) -> None:
...
async def test_retry_mechanism(
    webhook_event: WebhookEvent, processor_manager: WebhookProcessorManager
) -> None:
