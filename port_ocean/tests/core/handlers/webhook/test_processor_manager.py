...
# Replace the class with fixtures and standalone functions
@pytest.fixture
...
#     router: APIRouter, signal_handler: SignalHandler, mock_event: WebhookEvent
# ) -> None:
...
#     assert_event_processed_with_error(
#         processor_manager.running_processors[0]  # type: ignore
#     )
