...
class LifecycleClient:
    ...
    def __init__(self, base_url: str, auth: PortAuthentication) -> None:
        ...
        self.auth = auth
        self._client = OceanHttpClient(auth, timeout=10)
    ...
    async def notify_resync_started(
        ...
        await self._client.post(self._resync_url(resync_id), json=body)
    ...
    async def notify_started(
        ...
        await self._client.post(self._granular_url(event_id, granularity), json=body)
